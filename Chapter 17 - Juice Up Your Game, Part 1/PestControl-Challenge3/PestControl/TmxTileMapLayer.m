...
- (void)encodeWithCoder:(NSCoder *)aCoder
{
  ...
  [aCoder encodeCGSize:_tmxLayerSize
                forKey:@"TmxTML-LayerSize"];
}
...
- (instancetype)initWithCoder:(NSCoder *)aDecoder
{
  if (self = [super initWithCoder:aDecoder]) {
    ...
    _tmxTileSize =
    [aDecoder decodeCGSizeForKey:@"TmxTML-TileSize"];
    _tmxGridSize =
    [aDecoder decodeCGSizeForKey:@"TmxTML-GridSize"];
    _tmxLayerSize =
    [aDecoder decodeCGSizeForKey:@"TmxTML-LayerSize"];
  }
  return self;
}
