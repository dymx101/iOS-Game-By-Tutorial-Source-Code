...
- (void)setFacingBackAnim:(SKAction *)facingBackAnim {
  sharedFacingBackAnim = facingBackAnim;
}
...
- (void)setFacingForwardAnim:(SKAction *)facingForwardAnim {
  sharedFacingForwardAnim = facingForwardAnim;
}
...
- (void)setFacingSideAnim:(SKAction *)facingSideAnim {
  sharedFacingSideAnim = facingSideAnim;
}
