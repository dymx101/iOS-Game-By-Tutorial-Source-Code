    ...
    if (self = [super initWithSize:size]) {
        ...
        [self.dog runAction:[SKAction repeatActionForever:
            [SKAction sequence:@[
                ...
                [SKAction resizeToWidth:self.dog.size.width height:self.dog.size.height duration:1.0],
            ]]
        ]];
        ...
        [self.turtle runAction:[SKAction repeatActionForever:
            [SKAction sequence:@[
                [SKAction group:@[
                    [SKAction resizeToWidth:self.turtle.size.width*2 duration:1.0],
                    [SKAction resizeToHeight:self.turtle.size.height duration:1.0],
                ]],
                [SKAction group:@[
                    [SKAction resizeToWidth:self.turtle.size.width duration:1.0],
                    [SKAction resizeToHeight:self.turtle.size.height duration:1.0],
                ]],
            ]]
        ]];
