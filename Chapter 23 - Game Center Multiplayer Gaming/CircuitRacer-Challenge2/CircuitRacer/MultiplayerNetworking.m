...
typedef NS_ENUM(NSInteger, MessageType) {
  ...
  kMessageTypeHonk /*Multiplayer challenge 2*/
};
...
{
  MessageHonk honkMessage;
  honkMessage.message.messageType = kMessageTypeHonk;
  NSData *data = [NSData dataWithBytes:&honkMessage length:sizeof(MessageHonk)];
  [self sendData:data];
}
/*Multiplayer challenge 2*/
